		...
		<div className="skills">
			...
			<div className="description">
				<p>
					...
					so you can see me lurking around
					<a
						target="_blank"
				...
				<p>
					I love learning more about web techs so you may find me
					doing some personal projects, casually writing articles or
					notes, or learning more about design and other fields, other
					than code.
				</p>
				<p>
					In my free time, you’ll find me spending quality time with
