const worksData = [
  {
    ...
    description:
      'SPCC Caloocan Portal is a Laravel application that focuses on the grading system and school website. It also has features like class scheduling, course enlistment, printing of grades, enrollment of students, curriculum builder, etc. Did some UI/UX Design, Database Design, and Front & Back-end Development. Case Study on coming on Jan 2020.',
    auth:
