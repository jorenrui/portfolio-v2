const articlesData = [
  ...
  {
    id: 3,
    title: 'My Web Development Process Part 1: Design',
    description:
      'In building several web-based applications over a year, my process went through several changes. In the past, I went straight to code...',
    published_at: 'FEB 25, 2019',
    link: 'https://dev.to/jorenrui/my-web-development-process-part-1-design-7l1'
  }
];
